...
//           const allProviders = [...generalProviderDetails];
...
//           const allProviders = [...countyProviderDetails];
//           setProviders(allProviders);
//           console.log("Provider Details:", allProviders);
//         } else {
...
//         const url = locationEnabled
//           ? `/provider-delta?countyId=${selectedCounty}&provider_ids=${countyProviderIds.join(",")}&client_lat=${clientLocation.latitude}&client_lon=${clientLocation.longitude}`
//           : `/provider-delta?countyId=${selectedCounty}&provider_ids=${countyProviderIds.join(",")}`;
...
//       fetchProviderDetails();
//     }
//   }, [clientLocation, locationEnabled, selectedCounty]);
