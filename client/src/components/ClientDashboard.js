...
//   const [sortedByCounty, setSortedByCounty] = useState(false); 
//   const navigate = useNavigate();
...
//       if (response.ok) {
//         const responseData = await response.json();
//         const providerIdsKey = sortedByCounty ? "countyProviderIds" : "providerIds";
