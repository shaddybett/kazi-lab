...
import React, { useState, useEffect } from "react";
import { useNavigate } from "react-router-dom";
import { Avatar, Dropdown, Navbar, Button, Card, Modal } from "flowbite-react"; // Import Modal component
import ServiceProviders from "./ServiceProviders"; // Import ServiceProviders component
...
function ClientDashboard() {
  ...
  return (
    <div>
      ...
      {error && <p>{error}</p>}
      {/* Modal for displaying service providers */}
