...
//         `${backendUrl}/get_messages_between/${senderId}/${receiverId}`
//       );
//       if (response.ok) {
...
//           new Set(
//             messages.map((msg) =>
//               msg.sender_id === senderId ? msg.receiver_id : msg.sender_id
//             )
//           )
//         ).map((contactId) => ({
//           id: contactId,
...
//       <ChatWindow
//         activeUser={receiver}
//         messages={receiver ? sortedMessages[receiver] : []}
//         sendMessage={handleSendMessage}
//         currentUserId={senderId} // Or use admin's ID for the AdminPage
//       />
